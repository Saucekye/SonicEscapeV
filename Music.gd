...
# ─────────────────────────────
var scene_music := {
	"CharacterSelectScreen": preload("res://Music/zerogravitymenumix.MP3"),
	"warningscreen": preload("res://intro/sos(3).MP3")
}
...
var node2d_music_pool := [
	preload("res://backup/TNH NebulaChemical CyberFunk!  Fog Funk Cyberspace REMIX (Sonic Frontiers).mp3"),
	preload("res://Great Desert (Reboot Type A).mp3"),
	preload("res://Scent Of Love.mp3")
]
