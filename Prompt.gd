...
var follower_scene = preload("res://exe/exe.tscn")
...
func _process(delta: float) -> void:
	...
	if GlobalCanvasLayer.tricks > 20:
		...
		if texture_change == false:  
			...
			if new_texture.resource_path == "res://Sprite-00062.png" and not follower_spawned:
				spawn_follower()
