...
# Preloaded Scenes
# ─────────────────────────────────────────────
var smoke = preload("res://Smoke Attack.tscn")          # Air dash / burst smoke
var sparkle = preload("res://Sparkle.tscn")             # Trick sparkle effect
var smokeground = preload("res://misc/runsmoke.tscn")   # Foot dust when running fast
var ring_scene = preload("res://obstacles/rings/Rings.tscn")  # Rings scattered on damage
