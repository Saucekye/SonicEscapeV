...
# Chunk Scenes
# ─────────────────────────────
@export var chunk_start: PackedScene = preload("res://LevelChunks/Chunk_Start.tscn")

@export var chunk_01: PackedScene = preload("res://LevelChunks/Chunk_01.tscn")
@export var chunk_02: PackedScene = preload("res://LevelChunks/Chunk_02.tscn")
@export var chunk_03: PackedScene = preload("res://LevelChunks/Chunk_03.tscn")
@export var chunk_04: PackedScene = preload("res://LevelChunks/Chunk_04.tscn")
@export var chunk_05: PackedScene = preload("res://LevelChunks/Chunk_05.tscn")
@export var chunk_06: PackedScene = preload("res://LevelChunks/Chunk_06.tscn")

@export var chunk_boss: PackedScene = preload("res://LevelChunks/Chunk_Boss.tscn")
@export var chunk_end: PackedScene = preload("res://LevelChunks/Chunk_End.tscn")
@export var chunk_rest: PackedScene = preload("res://LevelChunks/Chunk_Rest.tscn")

# Miku
@export var miku_scene: PackedScene = preload("res://Miku/miku.tscn")
...
func _pick_random_chunk() -> PackedScene:
	var options := [chunk_01, chunk_02, chunk_03, chunk_04, chunk_05, chunk_06]
