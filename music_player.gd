...
var music_options = {
	"V0.1": {"stream": preload("res://Music/Tee Lopes - Stream Zone Act 1 (Live Stream Result).mp3"), "volume": -8},
	"V0.2": {"stream": preload("res://Music/Overcast - Breeze in the Clouds OST.mp3"), "volume": -8},
	"V0.3": {"stream": preload("res://Music/Omega Strikers - A Demon's Thunder (Mako's Theme) (In-Game Version) [16 Minute Extended Version].mp3"), "volume": 0},
	"V0.4": {"stream": preload("res://backup/Drift Back Home.mp3"), "volume": -8}
}
