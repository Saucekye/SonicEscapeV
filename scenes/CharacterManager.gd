...
func update_highlight_for_node(highlight_node: Node, character: SelectableCharacter):
	...
	match character.name:
		"Sonic":
			highlight_node.get_node("Texture").texture = load("res://Sonic/Sonichighlight.png")
		"Tails":
			highlight_node.get_node("Texture").texture = load("res://Tails/highlight.png")
		"Knuckles":
			highlight_node.get_node("Texture").texture = load("res://Knuckles/knuckleshighlight.png")
		"Amy":
			highlight_node.get_node("Texture").texture = load("res://Amy/Amyhighlight.png")
		"Rouge":
			highlight_node.get_node("Texture").texture = load("res://Rouge/rougehighlight.png")
		"Blaze":
			highlight_node.get_node("Texture").texture = load("res://Blaze/blazehighlight.png")
		"Cream":
			highlight_node.get_node("Texture").texture = load("res://Cream/creamhighlight.png")
		"MetalSonic":
			highlight_node.get_node("Texture").texture = load("res://Metal Sonic/metalhighlight1.png")
		_:
